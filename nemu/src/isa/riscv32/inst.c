...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall , N, (s->dnpc)=isa_raise_intr(11,s->pc);printf("dnpc=%#x\n",s->dnpc););
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret , N, printf("mepc=%#x\n",cpu.mepc);(s->dnpc)=(cpu.mepc));
