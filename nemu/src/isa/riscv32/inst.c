...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, uint64_t s1 =SEXT(src1,32);uint64_t s2=SEXT(src2,32); uint64_t im0=s1*s2;uint64_t im1=im0>>32; R(dest)= im1);
  ...
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, uint32_t s1 =src1;uint32_t s2=src2;R(dest)= s1%s2);
